...
namespace Win32
{
  public class Constants
  {
    ...
    public const uint SW_SCROLLCHILDREN = 1;
    public const uint SW_INVALIDATE = 2;
    public const uint SW_ERASE = 4;
    public const uint SW_SMOOTHSCROLL = 16;
