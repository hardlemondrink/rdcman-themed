...
namespace RdcMan
{
  public sealed class GlobalSettings : SettingsGroup
  {
    ...
    static GlobalSettings()
    {
      ...
      GlobalSettings._settingProperties[nameof (ThumbnailSize)].Attribute.DefaultValue = (object) new Size(160, 120);
      GlobalSettings._settingProperties[nameof (WindowPosition)].Attribute.DefaultValue = (object) new Point(200, 200);
      GlobalSettings._settingProperties[nameof (WindowSize)].Attribute.DefaultValue = (object) new Size(1273, 823);
    }
    ...
    {
      foreach (string key in GlobalSettings._settingProperties.Keys)
      {
        try
        {
          object transferValue = prefs.GetTransferValue(key);
          this.SetValue(key, transferValue);
        }
        catch
        {
        }
    ...
    {
      object obj = GlobalSettings._settingProperties[name].Property.GetValue((object) this, (object[]) null);
      return obj.GetType().GetProperty("Value").GetValue(obj, (object[]) null);
    }

    public void SetValue(string name, object value)
    {
      object obj = GlobalSettings._settingProperties[name].Property.GetValue((object) this, (object[]) null);
      obj.GetType().GetProperty("Value").SetValue(obj, value, (object[]) null);
    }
    ...
    protected override Dictionary<string, SettingProperty> SettingProperties => GlobalSettings._settingProperties;

    protected override void Copy(RdcTreeNode node) => throw new InvalidOperationException("GlobalSettings should never be copied");
